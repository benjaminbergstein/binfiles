...
noremap s :w <Enter>
noremap <C-G> :!git grep 
noremap <F2> :NERDTreeToggle <Enter>
noremap <F3> :NERDTreeFind <Enter>
noremap <F4> :sh <Enter>
noremap <F8> :!dv test rails % <Enter> <Enter>
noremap <F9> :!dv lint airstream <Enter> <Enter>
noremap <S-F8> :!! <Enter>
noremap <C-E> :Buffers <Enter>
noremap <C-F> :Rg <Enter>
noremap <C-P> :Files <Enter>
noremap .. :tabnext <Enter>
noremap ,, :tabprevious <Enter>
